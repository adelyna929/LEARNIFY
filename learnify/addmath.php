...
<html>
<head>
    <title>Additional Mathematics - LEARNIFY</title>
    ...
    <style>
        ...
        .hero {
            position: relative;
            background: url('addmathbg.jpg') center/cover no-repeat;
            height: 300px;
...
<!-- Hero Banner -->
<div class="hero">
  <h1>Additional Mathematics</h1>
  <p>“Mastering logic and problem-solving through numbers.”</p>
</div>
<!-- Dashboard Grid -->
<div class="dashboard">
  <div class="card">
  ...
  <div class="card">
    ...
    <a href="#" class="btn btn-outline-danger">Algebra</a>
    <a href="#" class="btn btn-outline-danger">Calculus</a>
    <a href="#" class="btn btn-outline-danger">Trigonometry</a>
    <a href="#" class="btn btn-outline-danger">Statistics</a>
  </div>

  <div class="card">
    <h3>Quizziz</h3>
    <p>Interactive quiz powered by Quizziz:</p>
    <iframe src="https://quizizz.com/embed/quiz/98765432" allowfullscreen></iframe>
    <div class="text-center mt-2">
      <a href="https://quizizz.com/quiz/98765432" target="_blank" class="btn btn-danger">Open in Quizziz</a>
    </div>
  </div>
  ...
  <div class="card">
    <h3>Announcements</h3>
    <p>📌 Assignment submission deadline: 18 Feb 2026</p>
    <p>📌 Quiz next week — revise your formulas!</p>
  </div>
   <div class="card">
