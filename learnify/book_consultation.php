...
<html>
<head>
    <title>Book Consultation - LEARNIFY</title>
    ...
    <style>
        ...
        .form-box{background-color:#FFFDD0;border-radius:15px;padding:30px;max-width:600px;margin:auto;box-shadow:0 0 10px rgba(0,0,0,0.2);}
    </style>
</head>
<body>
...
<main class="container mt-5">
  <h2 class="text-center">Book Consultation</h2>
  <div class="form-box mt-3">
    <form>
      <div class="mb-3">
        <label class="form-label">Select Lecturer</label>
        <select class="form-select">
          <option>Dr. Siti Noraini</option>
          <option>Prof. Ahmad Zaki</option>
        </select>
      </div>
      <div class="mb-3">
