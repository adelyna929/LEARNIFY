...
<head>
    ...
    <style>
        ...
        .hero {
            position: relative;
            background: url('economybg.jpg') center/cover no-repeat;
            height: 300px;
...
<div class="hero">
  <h1>Economy</h1>
  <p>“Exploring markets, trade, and financial systems.”</p>
</div>
<!-- Dashboard Grid -->
<div class="dashboard">
  <div class="card">
  ...
  <div class="card">
    ...
    <a href="#" class="btn btn-outline-danger">Microeconomics</a>
    <a href="#" class="btn btn-outline-danger">Macroeconomics</a>
    <a href="#" class="btn btn-outline-danger">International Trade</a>
    <a href="#" class="btn btn-outline-danger">Financial Systems</a>
  </div>

  <div class="card">
    <h3>Quizziz</h3>
    <p>Interactive quiz powered by Quizziz:</p>
    <iframe src="https://quizizz.com/embed/quiz/44332211" allowfullscreen></iframe>
    <div class="text-center mt-2">
      <a href="https://quizizz.com/quiz/44332211" target="_blank" class="btn btn-danger">Open in Quizziz</a>
    </div>
  </div>
  ...
  <div class="card">
    <h3>Announcements</h3>
    <p>📌 Assignment submission deadline: 25 Feb 2026</p>
    <p>📌 Group presentation next week — prepare your slides!</p>
  </div>
   <div class="card">
