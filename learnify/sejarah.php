...
<head>
    ...
    <style>
        ...
        .hero {
            position: relative;
            background: url('sejarahbg.jpg') center/cover no-repeat;
            height: 300px;
...
<div class="hero">
  <h1>Sejarah</h1>
  <p>“Learning from the past to guide the future.”</p>
</div>
<!-- Dashboard Grid -->
<div class="dashboard">
  <div class="card">
  ...
  <div class="card">
    ...
    <a href="#" class="btn btn-outline-danger">Ancient Civilizations</a>
    <a href="#" class="btn btn-outline-danger">World Wars</a>
    <a href="#" class="btn btn-outline-danger">Malaysian History</a>
    <a href="#" class="btn btn-outline-danger">Historical Figures</a>
  </div>

  <div class="card">
    <h3>Quizziz</h3>
    <p>Interactive quiz powered by Quizziz:</p>
    <iframe src="https://quizizz.com/embed/quiz/1357911" allowfullscreen></iframe>
    <div class="text-center mt-2">
      <a href="https://quizizz.com/quiz/1357911" target="_blank" class="btn btn-danger">Open in Quizziz</a>
    </div>
  </div>
  ...
  <div class="card">
    <h3>Announcements</h3>
    <p>📌 History essay submission deadline: 15 Feb 2026</p>
    <p>📌 Oral presentation next week — prepare your topic!</p>
  </div>
    <div class="card">
