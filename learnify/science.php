...
<head>
    ...
    <style>
        ...
        .hero {
            position: relative;
            background: url('sciencebg.jpg') center/cover no-repeat;
            height: 300px;
...
<div class="hero">
  <h1>Science</h1>
  <p>“Exploring the wonders of the universe.”</p>
</div>
<!-- Dashboard Grid -->
<div class="dashboard">
  <div class="card">
  ...
  <div class="card">
    ...
    <a href="#" class="btn btn-outline-danger">Physics</a>
    <a href="#" class="btn btn-outline-danger">Chemistry</a>
    <a href="#" class="btn btn-outline-danger">Biology</a>
    <a href="#" class="btn btn-outline-danger">General Science</a>
  </div>

  <div class="card">
    <h3>Quizziz</h3>
    <p>Interactive quiz powered by Quizziz:</p>
    <iframe src="https://quizizz.com/embed/quiz/24681012" allowfullscreen></iframe>
    <div class="text-center mt-2">
      <a href="https://quizizz.com/quiz/24681012" target="_blank" class="btn btn-danger">Open in Quizziz</a>
    </div>
  </div>
  ...
  <div class="card">
    <h3>Announcements</h3>
    <p>📌 Lab report submission deadline: 12 Feb 2026</p>
    <p>📌 Practical test next week — prepare your experiment!</p>
  </div>
   <div class="card">
