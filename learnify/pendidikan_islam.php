...
<html>
<head>
    <title>Pendidikan Islam - LEARNIFY</title>
    ...
    <style>
        ...
        .hero {
            position: relative;
            background: url('islamicbg.jpg') center/cover no-repeat;
            height: 300px;
...
<div class="hero">
  ...
  <p>“Mendalami ilmu dan akhlak Islam.”</p>
</div>
<!-- Dashboard Grid -->
<div class="dashboard">
  <div class="card">
  ...
  <div class="card">
    ...
    <a href="#" class="btn btn-outline-danger">Aqidah</a>
    <a href="#" class="btn btn-outline-danger">Fiqh</a>
    <a href="#" class="btn btn-outline-danger">Sirah</a>
    <a href="#" class="btn btn-outline-danger">Akhlak</a>
  </div>

  <div class="card">
    <h3>Quizziz</h3>
    <p>Interactive quiz powered by Quizziz:</p>
    <iframe src="https://quizizz.com/embed/quiz/55667788" allowfullscreen></iframe>
    <div class="text-center mt-2">
      <a href="https://quizizz.com/quiz/55667788" target="_blank" class="btn btn-danger">Open in Quizziz</a>
    </div>
  </div>
  ...
  <div class="card">
    <h3>Announcements</h3>
    <p>📌 Assignment submission deadline: 22 Feb 2026</p>
